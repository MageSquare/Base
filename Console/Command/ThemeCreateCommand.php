<?php
namespace MageSquare\Base\Console\Command;
...
use MageSquare\Base\Console\Command\ThemeCreate;
...
class ThemeCreateCommand extends Command
{
     ...
     * Inject dependencies
     *
     * @param \MageSquare\Base\Model\ComponentList\Loader $create
     */
    ...
    {
        $this->setName('magesquare:theme:create')
            ->setDescription('Create Local MageSquare theme')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (strpos($parent, 'MageSquare_ThemeFrontendArgento') === 0) {
            $parent = str_replace('MageSquare_ThemeFrontendArgento', '', $parent);
            $parent = strtolower($parent);
        }

        $parentThemeName = 'MageSquare/argento-' . $parent;
        $parentThemePackageName = 'magesquare/theme-frontend-argento-' . $parent;
        ...
        $output->writeln('<success>New Local MageSquare theme create done!</success>');
