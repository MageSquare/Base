...
namespace MageSquare\Base\Plugin\Backend\Model\Config;

use MageSquare\Base\Block\Adminhtml\System\Config\Advertise;
use MageSquare\Base\Model\Feed\AdsProvider;
...
class StructurePlugin
{
    ...
    const AMASTY_ADVERTISE = [
        'magesquare_advertise' => [
                'id' => 'magesquare_base_advertise',
                'type' => 'text',
                'label' => 'MageSquare Base Advertise',
                'children' => [
                    'label' => [
                        'id' => 'label',
                        'label' => '',
     ...
     * Tab name
     */
    const AMASTY_TAB_NAME = 'magesquare';
    ...
    private function getSectionAdvertise($displayedAdvertise)
    {
        ...
        $advertiseSection['magesquare_advertise']['data'] = $displayedAdvertise;

        if (isset($displayedAdvertise['tab_name'])) {
            $advertiseSection['magesquare_advertise']['label'] = strip_tags($displayedAdvertise['tab_name']);
