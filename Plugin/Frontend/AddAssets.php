...
namespace MageSquare\Base\Plugin\Frontend;

use MageSquare\Base\Model\LessToCss\Config\Converter;
...
class AddAssets
{
    const CACHE_KEY = 'magesquare_should_load_css_files';
    ...
    /**
     * @var \MageSquare\Base\Model\LessToCss\Config
     */
    private $lessConfig;
    ...
    public function __construct(
        ...
        \MageSquare\Base\Model\LessToCss\Config $lessConfig,
    ...
    {
        // i.e. 'MageSquare_Checkout::css/styles.css'
