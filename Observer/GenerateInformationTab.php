...
use MageSquare\Base\Plugin\Backend\Model\Menu\Item;
...
class GenerateInformationTab implements ObserverInterface
{
    ...
    const FEATURE_LINK = 'https://products.magesquare.com/request-a-feature';
    ...
    {
        $html = '<div class="magesquare-info-block">'
    ...
    {
        $src = $this->assetRepo->getUrl('MageSquare_Base::images/MageSqure.png');
        ...
        if ($content) {
            ...
            foreach ($content as $message) {
                if (isset($message['type'], $message['text'])) {
                    $html .= '<div class="magesquare-additional-content"><span class="message ' . $message['type'] . '">'
                        . $message['text']
                        . '</span></div>';
                }
            }
    ...
    {
        $html = '<div class="magesquare-module-version">';
    ...
    {
        $html = '<div class="magesquare-user-guide"><span class="message success">'
            . __(
    ...
    {
        return '<div class="msbase-buttons-container">'
            . $this->getFeatureLink()
    ...
    private function showModuleExistingConflicts()
    {
        ...
        if (count($messages)) {
            $html = '<div class="magesquare-conflicts-title">'
                . __('Problems detected:')
                . '</div>';

            $html .= '<div class="magesquare-disable-extensions">';
