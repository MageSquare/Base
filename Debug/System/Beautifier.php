...
use MageSquare\Base\Debug\VarDump;
...
class Beautifier
{
    ...
    {
        VarDump::magesquareEcho(Template::$debugJsCss);
    }
    ...
    public function beautify($var)
    {
        ...
        VarDump::magesquareEcho(sprintf(Template::$varWrapper, $result));
    }
