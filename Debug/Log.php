...
/**
 * For Remote Debug
 * Output is going to file magesquare_debug.log
 * @codeCoverageIgnore
...
class Log
{
     ...
     * @var string
     */
    private static $fileToLog = 'magesquare_debug.log';
...
%message%
----------------------------------------------------------------------------\n\n";
        $formatter = new System\MageSquareFormatter($output);

        $handler->setFormatter($formatter);
        self::$loggerInstance = new \Magento\Framework\Logger\Monolog('magesquare_logger', [$handler]);
    }
}
