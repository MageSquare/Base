...
class FeedContentProvider
{
     ...
     * Path to NEWS
     */
    const URN_NEWS = 'cdn.magesquare.com/feed-news-segments.xml';//do not use https:// or http

    /**
     * Path to ADS
     */
    const URN_ADS = 'magesquare.com/media/marketing/upsells.csv';

    /**
     * Path to EXTENSIONS
     */
    const URN_EXTENSIONS = 'cdn.magesquare.com/feed-extensions-m2.xml';
    ...
    public function getFeedContent(string $url)
    {
        ...
        $curlObject->setConfig(
            [
                'timeout' => 2,
                'useragent' => 'MageSquare Base Feed'
            ]
        );
