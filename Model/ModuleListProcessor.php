...
class ModuleListProcessor
{
    ...
    protected function getModuleInfo($moduleCode)
    {
        ...
        $module['description'] = $this->replaceMageSquareText($module['description']);
        ...
        if ($allExtensions && isset($allExtensions[$moduleCode])) {
            ...
            $module['description'] = $this->replaceMageSquareText($ext['name']);
     ...
     * @return string
     */
    protected function replaceMageSquareText($moduleName)
    {
        return str_replace(['for Magento 2', 'by MageSquare'], '', $moduleName);
    }
}
