...
namespace MageSquare\Base\Model\Import;

use MageSquare\Base\Model\Import\Behavior\BehaviorProviderInterface;
use MageSquare\Base\Model\Import\Mapping\MappingInterface;
use MageSquare\Base\Model\Import\Validation\EncodingValidator;
...
abstract class AbstractImport extends AbstractEntity
{
    ...
    const RUNTIME_ERRORS = 'ms_runtime_errors';
    ...
    protected function processValidation(array $rowData)
    {
        ...
        foreach ($this->validatorPool->getValidators() as $validator) {
            ...
            } catch (\MageSquare\Base\Exceptions\StopValidation $exception) {
