...
{
    const ADMIN_RESOURCE = 'MageSquare_Base::installer_install';

    /**
     * @var \MageSquare\Base\Helper\PopupMessageManager
     */
    ...
    public function __construct(
        ...
        \MageSquare\Base\Helper\PopupMessageManager $popupMessageManager
    ) {
