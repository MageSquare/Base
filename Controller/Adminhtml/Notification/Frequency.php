...
namespace MageSquare\Base\Controller\Adminhtml\Notification;
...
{
    /**
     * @var \MageSquare\Base\Model\Config
     */
    private $config;

    /**
     * @var \MageSquare\Base\Model\Source\Frequency
     */
    private $frequency;

    public function __construct(
        Action\Context $context,
        \MageSquare\Base\Model\Config $config,
        \MageSquare\Base\Model\Source\Frequency $frequency
    ) {
