...
namespace MageSquareBase\Test\Unit\Observer;

use MageSquareBase\Model\Feed\ExtensionsProvider;
use MageSquareBase\Model\ModuleInfoProvider;
use MageSquareBase\Observer\GenerateInformationTab;
use MageSquareBase\Test\Unit\Traits;
...
class GenerateInformationTabTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertEquals(
            '<div class="magesquare-additional-content"><span class="message success">test</span></div>',
