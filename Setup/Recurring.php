...
class Recurring implements \Magento\Framework\Setup\InstallSchemaInterface
{
    ...
    const IS_AMASTY_COLUMN = 'is_magesquare';
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if ($setup->getConnection()->isTableExists($setup->getTable(self::NOTIFICATION_TABLE))) {
            if (!$this->notificationTableColumnExist($setup, self::IS_AMASTY_COLUMN)) {
                $this->addIsMageSquareField($setup);
            }
     ...
     * @param SchemaSetupInterface $setup
     */
    private function addIsMageSquareField(SchemaSetupInterface $setup)
    {
        $setup->getConnection()->addColumn(
            ...
            [
                ...
                'nullable' => false,
                'default' => 0,
                'comment' => 'Is MageSquare Notification'
            ]
        );
    }
